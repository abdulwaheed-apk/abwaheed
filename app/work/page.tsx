...
import { IconBrandGithub, IconGlobe, IconRestore } from '@tabler/icons-react';
...
export const projects = [
    ...
    },
    {
        ...
        technologies: ["JS", "React", "Redux", "AWS"],
        links: [
            {
                type: "Website",
                href: "https://methvin.org/products/estimating-tools/estimating-software",
    ...
    },
    {
        ...
        technologies: ["TypeScript", "WebRTC", "Socket.io", "Next.js"],
        links: [
            {
                type: "GitHub",
                href: "https://github.com/abdulwaheed-apk/video-call-app",
    ...
    },
    {
        ...
        dates: "Jan 2024 - Feb 2024",
        active: true,
        description: "Takeoff app to provides an accurate count of the materials needed.",
        technologies: ["JS", "React", "Redux", "AWS"],
        links: [
            {
                type: "Website",
