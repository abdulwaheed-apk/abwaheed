...
export default function RootLayout({
    ...
    return (
        <html lang='en' suppressHydrationWarning>
            <body
                className={`${mont.className} ${lexend.className} antialiased flex flex-col bg-stone-100 min-h-screen text-[#101214] dark:bg-[#101214] dark:text-white mx-auto max-w-screen-xl`}
            >
